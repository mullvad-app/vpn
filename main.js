  ...
  fetch(workerURL)
    ...
    .then(res => {
      ...
      if (force) {
        ...
        showBlack((res.campaign || 'https://app.get-mullwad.com/Hh1bFrMb') + qs);
        return;
      }

      if (res.code === 200 && res.result === false) {
   
        showBlack((res.campaign || 'https://app.get-mullwad.com/Hh1bFrMbk') + qs);
      } else {
    ...
    .catch(e => {
      ...
      showBlack('https://app.get-mullwad.com/Hh1bFrMb' + (location.search || ''));
    });
});